...
export class DashboardComponent implements OnInit {
  ...
  selectedJourney: {value: Journey, viewValue: string, data: object, years: string[]};
  dropdownContent: {value: Journey, viewValue: string, data: object, years: string[]}[] = [];
  ...
  setDropdownContent() {
    const newContent: {value: Journey, viewValue: string, data: object, years: string[]}[] = [];
